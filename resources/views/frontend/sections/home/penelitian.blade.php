<div id="penelitian">
    <div class="flex flex-col items-center justify-between sm:flex-row">
        ...
        <a href=""
            class="flex items-center justify-start gap-1 p-2 text-sm bg-white border rounded-lg select-auto hover:bg-primary/10 border-primary text-primary">
    ...
    <div>
        ...
        <div class="relative mt-4 group">
                ...
                <div class="pb-9 swiper-wrapper">
                    @foreach (range(1, 10) as $item)
                        <div class="relative px-2 swiper-slide ">
                            <div
                                class="flex flex-col gap-3 p-4 transition-all border rounded-lg shadow-md cursor-pointer hover:border-primary hover:text-primary">
                                ...
                                <div>
                                    <h2 class="line-clamp-2">
                                        PENYUSUNAN DATABASE DAN MANAJEMEN PONDOK PESANTREN DI KABUPATEN BANDUNG BARAT
                                    </h2>
                                    <div class="text-xs">
                                        <ul>
                                            <li>
                                    ...
                                    <div class="flex justify-start itms-center">
                                        <a href=""
                                            class="flex items-center justify-center w-full gap-2 p-1 px-3 mt-3 text-center border rounded-lg hover:bg-primary/10 border-primary hover:text-black">
            ...
            <div
                class="absolute transition-all opacity-100 sm:opacity-0 group-hover:opacity-100 slide_next cursor-pointer  z-10 top-[40%] p-1 border rounded-full  bg-primary/10 -left-2 sm:-left-4">
                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                    viewBox="0 0 20 20">
            ...
            <div
                class="absolute transition-all opacity-100 sm:opacity-0 group-hover:opacity-100 slide_prev cursor-pointer  z-10 top-[40%] p-1 border rounded-full  bg-primary/10  -right-2 sm:-right-4">
                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                    viewBox="0 0 20 20">
                    <rect width="20" height="20" fill="none" />
